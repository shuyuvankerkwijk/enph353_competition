...
class CNN_driving_class:
    ...
    def image_callback(self, msg):
        ...
        if self.model is not None:
            ...
            lin_pred, ang_pred = self.model.predict(input_tensor)[0].numpy()
    ...
    def track_section_callback(self, msg):
        if not msg.data == self.section:
            ...
            if self.section == "Road":
                self.model = tf.keras.models.load_model('/home/fizzer/images_for_cnn_training/Road/best_model.h5')
            elif self.section == "Gravel":
                self.model = tf.keras.models.load_model('/home/fizzer/images_for_cnn_training/Gravel/best_model.h5')
            elif self.section == "OffRoad":
                self.model = tf.keras.models.load_model('/home/fizzer/images_for_cnn_training/OffRoad/best_model.h5')
            elif self.section == "ramp":
                self.model = tf.keras.models.load_model('/home/fizzer/images_for_cnn_training/ramp/best_model.h5')
            else:
